...
6. Với yêu cầu nhiều bước (ví dụ đặt lịch với cố vấn nhưng chưa biết tên cố vấn), hãy gọi Tool tra cứu trước, rồi dùng dữ liệu trong Observation làm tham số cho Tool tiếp theo.
7. Nếu Observation trả về NOT_FOUND hoặc lỗi, dừng các hành động phụ thuộc và thông báo lịch sự cho sinh viên.
"""

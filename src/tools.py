...
TOOLS_SCHEMA = [
    ...
    # --------------------------------------------------------------------------
    {
        ...
        "description": "Đặt lịch hẹn tư vấn học vụ với Cố vấn học tập VinUni. Nếu chưa biết tên cố vấn của sinh viên, hãy gọi 'academic_query' trước để lấy trường 'advisor'.",
        "parameters": {
            "type": "object",
            "properties": {
                "student_id": {
